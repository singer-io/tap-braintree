...
class TestTimeout(unittest.TestCase):
    ...
    def test_request_timeout_invalid_value(self, name, test_value, expected_value, mocked_parse_args,mocked_configure, mocked_discover, mocked_environment):
        '''
    ...
    @mock.patch("tap_braintree.braintree.Configuration")
    @mock.patch("tap_braintree.utils.parse_args" )
    def test_request_timeout_valid_value(self,name, test_value, expected_value, mocked_parse_args,mocked_configure, mocked_discover, mocked_environment):
        """
