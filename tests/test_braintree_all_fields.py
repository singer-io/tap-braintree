        ...
        for stream in expected_streams:
            with self.subTest(stream=stream):
                ...
                self.assertTrue(
                    ...
                    msg='{} is not in "expected_all_keys"'.format(
                        expected_automatic_keys - expected_all_keys
                    ),
                )
