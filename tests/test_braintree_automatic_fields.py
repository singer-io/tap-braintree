...
class AutomaticFields(BraintreeBaseTest):
    ...
    def name():
        ...
        return "tap_tester_braintree_automatic_fields"
    ...
    def test_run(self):
        ...
        for stream in expected_streams:
            with self.subTest(stream=stream):
                ...
                keys = data["schema"]["properties"].keys()
                actual_keys = set()
                for key in keys:
                    if data["schema"]["properties"][key]["inclusion"] == "automatic":
                        actual_keys.add(key)
